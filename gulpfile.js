...
//一级
{
    ...
    task: function (callBack) {
        runSequence('clearAdd', 'gitAdd', 'utf8bomClearDiff', 'commitMinCss', 'commitMinJs', 'gitAdd', 'gitCommit', 'gitPull', 'gitPush', callBack);
    }
},
{
    id: 2,
    text: '打包：文本检测 -> 打zip包',
    task: function (callBack) {
        runSequence('utf8bomClear', 'pack', callBack);
    }
},
{
    id: 3,
...
var saveConfig = function () {
    return gulp.src("./node_modules/config.json")
...
gulp.task('watch', function () {
  // 监控sass
  gulp.watch([ './public/css/home/**/*.scss' ], ['sass']);  
  // 监控html/css/images/js
  gulp.watch([ './application/views/**/*.phtml', './public/css/**/*.css', './public/images/**/*.{png,jpg,jpeg,gif}', './public/js/**/*.js' ], ['restart']);
});
...
gulp.task('sass', function () {
  return sass( './public/css/home/**/*.scss', { style: 'compressed' } )
