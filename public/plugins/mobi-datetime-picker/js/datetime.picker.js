    ...
    ms.classes.Frame = function (el, settings, inherit) {
        ...
        function show(beforeShow, $elm) {
            ...
            if (that.show() !== false) {
                ...
                setTimeout(function () {
                    preventShow = false;
                }, 300); // With Zepto < 1.9 focus is fired twice in IE
            }
        }
        ...
        that.position = function (check) {
            ...
            modalWidth = $popup.width();
            modalHeight = $popup.height();
            ...
            if (s.display == 'modal') {
                ...
                aw = anchor.width();
                ah = anchor.height();
                l = constrain(al - ($popup.width() - aw) / 2, sl + 3, sl + nw - modalWidth - 3);
         ...
         * @param {Zepto} $elm - Events will be attached to this element.
